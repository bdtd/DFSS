...
interpreter = tf.lite.Interpreter('/home/junaid/Downloads/Image-Classification-on-Flask-master/quan_siamese_mobilenet_crop_7e.tflite')
...
def predict_label(img_path):
	...
	imgs = np.concatenate((i, j), axis=3)
